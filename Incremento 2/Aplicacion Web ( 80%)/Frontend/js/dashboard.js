document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Renderizar secciones dinámicamente según permisos
  SECCIONES.forEach((seccion) => {
    // Revisamos si al menos una subsección está permitida
    ...
    if (subseccionesVisibles.length === 0) return // nada que mostrar en esta sección
    ...
    subseccionesVisibles.forEach((sub) => {
