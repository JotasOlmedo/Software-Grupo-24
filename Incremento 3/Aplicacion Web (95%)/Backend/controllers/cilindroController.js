...
exports.registrar = async (req, res) => {
  ...
  try {
    ...
    notificationService.checkStockLevels().catch((err) => {
      console.error("Error checking stock after cylinder registration:", err)
    })
...
exports.actualizarEstado = async (req, res) => {
  ...
  try {
    ...
    notificationService.checkStockLevels().catch((err) => {
      console.error("Error checking stock after state update:", err)
    })
