    ...
    filtrado.forEach(h => {
      const fila = `
        <tr>
          ...
          <td class = "text-center">${h.hora}</td>
          <td class = "text-center"><span class="px-2 py-1 text-xs bg-purple-100 text-purple-700 rounded">${h.accion}</span></td>
          <td class = "text-center">${h.detalles}</td>
        </tr>`;
