...
exports.crear = async (req, res) => {
  try {
    const { titulo, contenido, fecha_expiracion, usuario_admin } = req.body
    ...
    await registrarHistorial(usuario_admin || "Admin", "Mensaje fijado creado", `Se creó el mensaje "${titulo}"`)
...
exports.desactivar = async (req, res) => {
  try {
    ...
    await registrarHistorial(usuario_admin || "Admin", "Mensaje fijado desactivado", `Se desactivó el mensaje ID ${id}`)
